...
output_path = base_path + "/dataset/submission_cv_lr_stacked.csv"

x_train_1, y_train_1, x_test, id_test, label_encoder_1 = load_preprocessed_data(train_path_1, test_path)

print("Initiating Logistic Regression Classifier 1")
model_1 = LogisticRegression(penalty='l2', C=100, random_state=0, n_jobs=-1)
...
print("Mean score:")
print(scores.mean())
print("Training Logistic Regression Classifier 1")
...
print("Initiating Logistic Regression Classifier 2")
model_2 = LogisticRegression(penalty='l2', C=100, random_state=0, n_jobs=-1)
print("Starting CV 5-fold")
...
print("Mean score:")
print(scores.mean())
print("Training Logistic Regression Classifier 2")
