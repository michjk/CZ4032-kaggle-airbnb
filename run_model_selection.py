...
param_grid = dict(n_estimators= n_estimators, max_depth = max_depth, learning_rate=learning_rates)

x_train, y_train, x_test, id_test, label_encoder = load_preprocessed_data(train_path, test_path)

#train
model = xgb.XGBClassifier(objective="multi:softprob", subsample=0.5, colsample_bytree=0.5, seed=0)
